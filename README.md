...
```bash
docker compose exec backend php artisan test   # 457 tests — parity baseline, domain, admin (Livewire), invoices, payments, stock, CSV import, Telegram, tenant isolation, storefront hosts, full API
