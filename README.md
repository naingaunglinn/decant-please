...
```bash
docker compose exec backend php artisan test   # 103 tests — domain, admin (Livewire), invoices, payments, stock, CSV import, Telegram, full API
...
```bash
cd backend && php artisan test   # same 103 tests, using your local toolchain
