...
return [
    ...
    */
    ...
    'super_admin' => [
        // Step 34 / ADR-0003 amendment: studio_admin IS Shield's super_admin —
        // platform-wide via Gate::before interception (grants all abilities). The
        // studio operator's account holds this role; is_studio derives from it.
        'enabled' => true,
        'name' => 'studio_admin',
        // true → Shield registers a Gate::before that grants studio_admin every
        // ability (no explicit permission list needed). This IS the platform-wide
        // super_admin bypass the architecture calls for; without it, super_admin
        // would instead need all permissions synced onto the role.
