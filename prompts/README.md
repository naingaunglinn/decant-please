...
| 45 | `45-help-button.md` | **Help button** — admin → studio on Telegram / Viber by deep link (the seller sends, the platform sends nothing); also under the login and sign-up forms; platform env, blank = hidden | **built (v54)** (#140); no migration; 533 tests on Postgres 17 |
